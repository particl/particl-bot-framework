...
export class BotAuthorMigration1573214073088 implements MigrationInterface {
    name = 'BotAuthorMigration1573214073088'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_exchanges" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "track_id" varchar NOT NULL, "currency_from" varchar NOT NULL, "currency_to" varchar NOT NULL, "amount_from" varchar NOT NULL, "amount_to" varchar NOT NULL, "address_from" varchar NOT NULL, "address_to" varchar NOT NULL, "status" varchar NOT NULL, "tx_from" varchar NOT NULL, "tx_to" varchar NOT NULL, "wallet" varchar NOT NULL, "botAddress" varchar)`, undefined);
        ...
        // Add BotAuthor
        await queryRunner.query(`CREATE TABLE "bot_author" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar, "email" varchar, "chat_ids" text)`, undefined);
        await queryRunner.query(`CREATE TABLE "temporary_bots" ("address" varchar PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "description" text NOT NULL, "version" varchar NOT NULL, "type" varchar NOT NULL, "image" varchar NOT NULL, "authorId" integer, CONSTRAINT "UQ_4cb5df227616d0d127558785471" UNIQUE ("authorId"))`, undefined);
        await queryRunner.query(`INSERT INTO "temporary_bots"("address", "name", "description", "version", "type", "image") SELECT "address", "name", "description", "version", "type", "image" FROM "bots"`, undefined);
        ...
        await queryRunner.query(`DROP TABLE "wallet_addresses"`, undefined);
        await queryRunner.query(`ALTER TABLE "temporary_wallet_addresses" RENAME TO "wallet_addresses"`, undefined);
        await queryRunner.query(`CREATE TABLE "temporary_bots" ("address" varchar PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "description" text NOT NULL, "version" varchar NOT NULL, "type" varchar NOT NULL, "image" varchar NOT NULL, "authorId" integer, CONSTRAINT "UQ_4cb5df227616d0d127558785471" UNIQUE ("authorId"), CONSTRAINT "UQ_bf316b2bcf8480dc1fbaac3ccd9" UNIQUE ("address"), CONSTRAINT "FK_907a3770ffa6e179f7370920356" FOREIGN KEY ("authorId") REFERENCES "bot_author" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "bots" ("address" varchar PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "description" text NOT NULL, "version" varchar NOT NULL, "type" varchar NOT NULL, "image" varchar NOT NULL, "authorId" integer, CONSTRAINT "UQ_4cb5df227616d0d127558785471" UNIQUE ("authorId"), CONSTRAINT "UQ_bf316b2bcf8480dc1fbaac3ccd9" UNIQUE ("address"))`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "bots" RENAME TO "temporary_bots"`, undefined);
        await queryRunner.query(`CREATE TABLE "bots" ("address" varchar PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "description" text NOT NULL, "version" varchar NOT NULL, "type" varchar NOT NULL, "image" varchar NOT NULL, "authorId" integer, CONSTRAINT "UQ_4cb5df227616d0d127558785471" UNIQUE ("authorId"))`, undefined);
        await queryRunner.query(`INSERT INTO "bots"("address", "name", "description", "version", "type", "image", "authorId") SELECT "address", "name", "description", "version", "type", "image", "authorId" FROM "temporary_bots"`, undefined);
        await queryRunner.query(`DROP TABLE "temporary_bots"`, undefined);
        await queryRunner.query(`ALTER TABLE "exchanges" RENAME TO "temporary_exchanges"`, undefined);
        ...
        await queryRunner.query(`DROP TABLE "temporary_bot_wallets"`, undefined);
        await queryRunner.query(`ALTER TABLE "bots" RENAME TO "temporary_bots"`, undefined);
        await queryRunner.query(`CREATE TABLE "bots" ("address" varchar PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "description" text NOT NULL, "version" varchar NOT NULL, "type" varchar NOT NULL, "image" varchar NOT NULL)`, undefined);
        await queryRunner.query(`INSERT INTO "bots"("address", "name", "description", "version", "type", "image") SELECT "address", "name", "description", "version", "type", "image" FROM "temporary_bots"`, undefined);
        await queryRunner.query(`DROP TABLE "temporary_bots"`, undefined);
        await queryRunner.query(`DROP TABLE "bot_author"`, undefined);
        await queryRunner.query(`ALTER TABLE "wallet_addresses" RENAME TO "temporary_wallet_addresses"`, undefined);
        await queryRunner.query(`CREATE TABLE "wallet_addresses" ("wallet" varchar PRIMARY KEY NOT NULL, "address" text NOT NULL)`, undefined);
        await queryRunner.query(`INSERT INTO "wallet_addresses"("wallet", "address") SELECT "wallet", "address" FROM "temporary_wallet_addresses"`, undefined);
        await queryRunner.query(`DROP TABLE "temporary_wallet_addresses"`, undefined);
